...
KNNLearn().run(data=data_tic_tac_toe, title='Tic-tac-toe KNN classifier', flag=True)

data_spam = read_csv('spam.txt', sep=",", header=0)
KNNLearn().run(data=data_spam, title='Spam KNN classifier', flag=False)
